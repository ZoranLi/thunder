...
*/
        /*
        r6 = this;
        r0 = r6.mSetExclusiveCheckableMethod;	 Catch:{ Exception -> 0x002c }
        r1 = 0;	 Catch:{ Exception -> 0x002c }
        r2 = 1;	 Catch:{ Exception -> 0x002c }
        if (r0 != 0) goto L_0x001c;	 Catch:{ Exception -> 0x002c }
    L_0x0006:
        r0 = r6.mWrappedObject;	 Catch:{ Exception -> 0x002c }
        r0 = (android.support.v4.internal.view.SupportMenuItem) r0;	 Catch:{ Exception -> 0x002c }
        r0 = r0.getClass();	 Catch:{ Exception -> 0x002c }
        r3 = "setExclusiveCheckable";	 Catch:{ Exception -> 0x002c }
        r4 = new java.lang.Class[r2];	 Catch:{ Exception -> 0x002c }
        r5 = java.lang.Boolean.TYPE;	 Catch:{ Exception -> 0x002c }
        r4[r1] = r5;	 Catch:{ Exception -> 0x002c }
        r0 = r0.getDeclaredMethod(r3, r4);	 Catch:{ Exception -> 0x002c }
        r6.mSetExclusiveCheckableMethod = r0;	 Catch:{ Exception -> 0x002c }
    L_0x001c:
        r0 = r6.mSetExclusiveCheckableMethod;	 Catch:{ Exception -> 0x002c }
        r3 = r6.mWrappedObject;	 Catch:{ Exception -> 0x002c }
        r2 = new java.lang.Object[r2];	 Catch:{ Exception -> 0x002c }
        r7 = java.lang.Boolean.valueOf(r7);	 Catch:{ Exception -> 0x002c }
    ...
    L_0x002c:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.view.menu.MenuItemWrapperICS.setExclusiveCheckable(boolean):void");
    }
