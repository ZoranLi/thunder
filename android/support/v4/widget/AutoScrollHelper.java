...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        public void start() {
            ...
            this.mStopValue = PayBaseConstants.HALF_OF_FLOAT;
            this.mDeltaX = 0;
            this.mDeltaY = 0;
        }
        ...
        private float getValueAt(long j) {
            ...
            if (this.mStopTime >= 0) {
                if (j >= this.mStopTime) {
                    return (1065353216 - this.mStopValue) + (this.mStopValue * AutoScrollHelper.constrain(((float) (j - this.mStopTime)) / ((float) this.mEffectiveRampDown), 0.0f, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY));
                }
            }
            return 1056964608 * AutoScrollHelper.constrain(((float) (j - this.mStartTime)) / ((float) this.mRampUpDuration), 0.0f, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY);
        }
    ...
    public AutoScrollHelper(View view) {
        ...
        int i = (int) ((1575.0f * view.density) + PayBaseConstants.HALF_OF_FLOAT);
        view = (int) ((315.0f * view.density) + PayBaseConstants.HALF_OF_FLOAT);
        float f = (float) i;
