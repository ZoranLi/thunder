...
class MediaBrowserServiceCompatApi21 {
    ...
    static class MediaBrowserServiceAdaptor extends MediaBrowserService {
        ...
        public android.service.media.MediaBrowserService.BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
            str = this.mServiceProxy.onGetRoot(str, i, bundle == null ? null : new Bundle(bundle));
            if (str == null) {
                return null;
            }
            return new android.service.media.MediaBrowserService.BrowserRoot(str.mRootId, str.mExtras);
        }
