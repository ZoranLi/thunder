...
public class ConstraintSet {
    ...
    private static class Constraint {
        ...
        private Constraint() {
            ...
            this.endToStart = -1;
            this.endToEnd = -1;
            this.horizontalBias = PayBaseConstants.HALF_OF_FLOAT;
            this.verticalBias = PayBaseConstants.HALF_OF_FLOAT;
    ...
    public void centerHorizontally(int i, int i2) {
        if (i2 == 0) {
            center(i, 0, 1, 0, 0, 2, 0, PayBaseConstants.HALF_OF_FLOAT);
        } else {
            center(i, i2, 2, 0, i2, 1, 0, PayBaseConstants.HALF_OF_FLOAT);
        }
    }

    public void centerHorizontallyRtl(int i, int i2) {
        if (i2 == 0) {
            center(i, 0, 6, 0, 0, 7, 0, PayBaseConstants.HALF_OF_FLOAT);
        } else {
            center(i, i2, 7, 0, i2, 6, 0, PayBaseConstants.HALF_OF_FLOAT);
        }
    }

    public void centerVertically(int i, int i2) {
        if (i2 == 0) {
            center(i, 0, 3, 0, 0, 4, 0, PayBaseConstants.HALF_OF_FLOAT);
        } else {
            center(i, i2, 4, 0, i2, 3, 0, PayBaseConstants.HALF_OF_FLOAT);
        }
    }
            ...
            if (i2 != 60) {
                switch (i2) {
                    ...
                    case 53:
                        ...
                        break;
                    default:
                        StringBuilder stringBuilder = new StringBuilder("Unknown attribute 0x");
