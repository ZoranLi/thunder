...
public class BottomNavigationView extends FrameLayout {
    ...
    public BottomNavigationView(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, R.styleable.BottomNavigationView, i, R.style.Widget_Design_BottomNavigationView);
        if (attributeSet.hasValue(R.styleable.BottomNavigationView_itemIconTint) != 0) {
            this.mMenuView.setIconTintList(attributeSet.getColorStateList(R.styleable.BottomNavigationView_itemIconTint));
        } else {
        ...
        if (attributeSet.hasValue(R.styleable.BottomNavigationView_itemTextColor) != 0) {
            this.mMenuView.setItemTextColor(attributeSet.getColorStateList(R.styleable.BottomNavigationView_itemTextColor));
        } else {
        ...
        this.mMenuView.setItemBackgroundRes(attributeSet.getResourceId(R.styleable.BottomNavigationView_itemBackground, 0));
