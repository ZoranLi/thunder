...
public class AsyncOperation {
    ...
    AsyncOperation(OperationType operationType, AbstractDao<?, ?> abstractDao, Database database, Object obj, int i) {
        ...
        this.parameter = obj;
        this.creatorStacktrace = (i & 4) != null ? new Exception("AsyncOperation was created here") : null;
    }
    ...
    boolean isMergeableWith(AsyncOperation asyncOperation) {
        return (asyncOperation != null && isMergeTx() && asyncOperation.isMergeTx() && getDatabase() == asyncOperation.getDatabase()) ? true : null;
    }
    ...
    public synchronized boolean waitForCompletion(int i) {
        if (!this.completed) {
            try {
                ...
                throw new DaoException("Interrupted while waiting for operation to complete", i2);
            }
        }
        return this.completed;
    }
