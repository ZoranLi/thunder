...
public class QueryBuilder<T> {
    ...
    public QueryBuilder<T> whereOr(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
        this.whereCollector.add(or(whereCondition, whereCondition2, whereConditionArr), new WhereCondition[null]);
        return this;
    }

    public WhereCondition or(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
        return this.whereCollector.combineWhereConditions(b.d, whereCondition, whereCondition2, whereConditionArr);
    }

    public WhereCondition and(WhereCondition whereCondition, WhereCondition whereCondition2, WhereCondition... whereConditionArr) {
        return this.whereCollector.combineWhereConditions(b.c, whereCondition, whereCondition2, whereConditionArr);
    }
    ...
    public <J> Join<T, J> join(Property property, Class<J> cls) {
        cls = this.dao.getSession().getDao(cls);
        return addJoin(this.tablePrefix, property, cls, cls.getPkProperty());
    }
    ...
    private void checkLog(String str) {
        if (LOG_SQL) {
            StringBuilder stringBuilder = new StringBuilder("Built SQL for query: ");
            stringBuilder.append(str);
            DaoLog.d(stringBuilder.toString());
        }
        if (LOG_VALUES != null) {
            str = new StringBuilder("Values for query: ");
            str.append(this.values);
            DaoLog.d(str.toString());
        }
    }
