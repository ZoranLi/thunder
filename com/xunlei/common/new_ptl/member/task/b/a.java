...
public final class a extends com.xunlei.common.new_ptl.member.task.a {
    ...
    private String l = "";
    private i m = null;
    private XLThirdUserInfo n = null;
    private int o = -1;

    static /* synthetic */ int a(a aVar, int i) {
        return i == 200 ? 0 : i == 602 ? XLErrorCode.BIND_DUPLICATE_ERROR : i == 600 ? 13 : i == 502 ? 20000 : XLErrorCode.BIND_ERROR;
    }
    ...
    public final boolean a(XLOnUserListener xLOnUserListener, Bundle bundle) {
        if (xLOnUserListener != null) {
            if (bundle != null) {
                return xLOnUserListener.onUserBindedOtherAccount(bundle.getInt("errorCode"), bundle.getString("errorDesc"), "", this.o, this.n, f(), g());
            }
        }
        return null;
    }
