...
public final class k implements Runnable {
    ...
    public k(a aVar, String str, e$d com_xunlei_downloadprovider_member_payment_a_e_d) {
        this.d = aVar;
        this.b = str;
...
*/
    ...
    L_0x0023:
        r0 = "latest_row_key";	 Catch:{ JSONException -> 0x004d }
        r1 = r8.b;	 Catch:{ JSONException -> 0x004d }
        r3.put(r0, r1);	 Catch:{ JSONException -> 0x004d }
    L_0x002a:
        r0 = new java.lang.StringBuilder;	 Catch:{ JSONException -> 0x004d }
        r1 = "getFollowingLatestVideoFeedList:json=>";	 Catch:{ JSONException -> 0x004d }
        ...
        r2 = "http://api-shoulei-ssl.xunlei.com/dynamic/publish_latest";	 Catch:{ JSONException -> 0x004d }
        r4 = new com.xunlei.downloadprovider.homepage.follow.c.l;	 Catch:{ JSONException -> 0x004d }
        r4.<init>(r8);	 Catch:{ JSONException -> 0x004d }
        r5 = new com.xunlei.downloadprovider.homepage.follow.c.o;	 Catch:{ JSONException -> 0x004d }
    ...
    L_0x004d:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xunlei.downloadprovider.homepage.follow.c.k.run():void");
    }
}
