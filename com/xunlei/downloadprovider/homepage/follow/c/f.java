...
*/
        ...
        r1 = "getFollowingVideoFeedList result=";
        r0.<init>(r1);
        r0.append(r6);
        r0 = "result";
        r0 = r6.optString(r0);
    ...
    L_0x0047:
        r1 = r2;
    L_0x0048:
        r6 = new com.xunlei.downloadprovider.homepage.follow.c.g;
        r6.<init>(r5, r0, r1);
        com.xunlei.downloadprovider.homepage.follow.c.a.j(r6);
        return;
    L_0x0051:
        r6 = new com.xunlei.downloadprovider.homepage.follow.c.h;
        r6.<init>(r5, r0);
        com.xunlei.downloadprovider.homepage.follow.c.a.j(r6);
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xunlei.downloadprovider.homepage.follow.c.f.onResponse(java.lang.Object):void");
    }
}
