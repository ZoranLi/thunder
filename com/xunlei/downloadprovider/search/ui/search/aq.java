...
final class aq implements OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        view = view.toString();
        SearchOperateActivity searchOperateActivity = (SearchOperateActivity) this.b.d;
        String str = this.a.b;
        ...
        if (!k.a.d(str)) {
            ...
            XLThreadPool.execute(new bd(searchOperateActivity, str, str2));
            str = stringBuilder2;
        }
        searchOperateActivity.a();
        com.xunlei.downloadprovider.web.a.a();
        com.xunlei.downloadprovider.web.a.a(searchOperateActivity, 22, str, true, BrowserFrom.SEARCH_THINK);
        if (this.a.m == null) {
            view = this.a.b;
        }
        ...
        if (this.a.m == null && k.a.d(this.a.b) != null) {
            XLThreadPool.execute(new ar(this));
        }
    }
}
