...
public final class a {
    ...
    public static void a(String str, String str2, String str3, String str4, boolean z) {
        ...
        StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_follow_click");
    ...
    public static void a(String str, String str2, String str3, String str4, boolean z, String str5, String str6, int i) {
        ...
        StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_follow_click_result");
        build.add("movieid", str);
        build.add("author_id", str2);
        build.add("tabid", str3);
        build.add("author_type", str4);
    ...
    public static void a(String str) {
        if (!a.isEmpty()) {
            ...
            StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_content_show");
            build.addString("lbs_video_auto_ugc", stringBuilder.toString());
    ...
    L_0x005c:
        r4 = "shortvideo_topic_LBS";
        goto L_0x0070;
    L_0x005f:
        r4 = "shortvideo_music_LBS";
        goto L_0x0070;
    L_0x0062:
        r4 = "shortvideo_LBS_LBS";
        goto L_0x0070;
    L_0x0065:
        r4 = "home_collect_LBS";
        goto L_0x0070;
    L_0x0068:
        r4 = "home_followtab_LBS";
        goto L_0x0070;
    L_0x006b:
        r4 = "shortvideo_usercenter_LBS";
        goto L_0x0070;
    L_0x006e:
        r4 = "videoDetail";
    L_0x0070:
        ...
        r4 = "location";
        r1 = "UTF-8";
        r3 = com.xunlei.xllib.b.k.c(r3, r1);
        r0.add(r4, r3);
        a(r0);
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xunlei.downloadprovider.publiser.a.a.a(java.lang.String, java.lang.String):void");
    }

    public static void b(String str, String str2) {
        StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_content_click");
        build.add("movieid", str);
        build.add("format_type", "lbs_video_auto_ugc");
        build.add("tabid", str2);
        a(build);
    }

    public static void a(String str, String str2, String str3, String str4) {
        StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_zan");
        build.add("movieid", str);
        build.add("author_id", str2);
        build.add("tabid", str3);
    ...
    public static void a(String str, String str2, String str3) {
        StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_discuss_click");
        build.add("movieid", str);
        build.add("author_id", str2);
        build.add("tabid", str3);
        a(build);
    ...
    public static void b(String str, String str2, String str3, String str4) {
        StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_share_to");
        build.add("to", str4);
        build.add("movieid", str);
        build.add("author_id", str2);
        build.add("tabid", str3);
    ...
    public static void a(String str, String str2, String str3, int i, String str4, String str5) {
        StatEvent build = HubbleEventBuilder.build("android_LBS_collect", "LBS_collect_share_result");
        build.add("to", str2);
