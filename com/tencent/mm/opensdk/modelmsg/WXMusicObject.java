...
public class WXMusicObject implements IMediaObject {
    ...
    public boolean checkArgs() {
        return ((this.musicUrl == null || this.musicUrl.length() == 0) && (this.musicLowBandUrl == null || this.musicLowBandUrl.length() == 0)) ? false : (this.musicUrl == null || this.musicUrl.length() <= LENGTH_LIMIT) ? this.musicLowBandUrl == null || this.musicLowBandUrl.length() <= LENGTH_LIMIT : false;
    }
