...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                ...
                stringBuilder.append(pathOldToNew);
        ...
        private static String pathOldToNew(String str) {
            if (str != null) {
                ...
                str = str.replace("com.tencent.mm.sdk.openapi", "com.tencent.mm.opensdk.modelmsg");
            }
            return str;
        }
    ...
    public interface IMediaObject {
        ...
        public static final int TYPE_URL = 50;
    ...
    final boolean checkArgs() {
        return (getType() == 8 && (this.thumbData == null || this.thumbData.length == 0)) ? false : (this.thumbData == null || this.thumbData.length <= 32768) ? (this.title == null || this.title.length() <= 512) ? ((this.description == null || this.description.length() <= 1024) && this.mediaObject != null) ? (this.mediaTagName == null || this.mediaTagName.length() <= 64) ? (this.messageAction == null || this.messageAction.length() <= 2048) ? (this.messageExt == null || this.messageExt.length() <= 2048) ? this.mediaObject.checkArgs() : false : false : false : false : false : false;
    }
    ...
    public final void setThumbImage(Bitmap bitmap) {
        try {
            ...
            new StringBuilder("setThumbImage exception:").append(e.getMessage());
        }
    }
}
