...
public abstract class ProxyWebViewClientExtension implements IX5WebViewClientExtension {
        ...
        if (this.mWebViewClientExt != null && sCompatibleOnMetricsSavedCountReceived) {
            try {
                ...
                if (e.getMessage() != null) {
                    if (e.getMessage().contains("onMetricsSavedCountReceived")) {
    ...
    public boolean overScrollBy(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z, View view) {
        return this.mWebViewClientExt != null ? r0.mWebViewClientExt.overScrollBy(i, i2, i3, i4, i5, i6, i7, i8, z, view) : false;
    }
