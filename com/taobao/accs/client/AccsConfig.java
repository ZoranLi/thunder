...
public class AccsConfig {
    ...
    public static void setChannelHosts(String str, String str2, String str3) {
        ALog.i(TAG, "env", new Object[]{Integer.valueOf(ACCSManager.mEnv), "setChannelHosts", "releaseHost", str, "prepareHost", str2, "dailyHost", str3});
    ...
    public static void setTnetPubkey(int i, int i2) {
        ALog.i(TAG, "setTnetPubkey", new Object[]{"pubKey", Integer.valueOf(i), "channelPubKey", Integer.valueOf(i2)});
    ...
    public static void setAccsCenterHosts(String str, String str2, String str3) {
        if (!(TextUtils.isEmpty(str) || TextUtils.isEmpty(str2))) {
            if (!TextUtils.isEmpty(str3)) {
                ALog.i(TAG, "setAccsCenterHost", new Object[]{"env", Integer.valueOf(ACCSManager.mEnv), "releaseHost", str, "prepareHost", str2, "dailyHost", str3});
                switch (ACCSManager.mEnv) {
                    case 1:
