        ...
        if (jSONObject != null) {
            ...
            while (keys.hasNext()) {
                try {
                    ...
                    if (!e.a(encode2)) {
                        if (com.xunlei.downloadprovider.pushmessage.e.a.equals(encode)) {
                            setE(encode2);
                        } else if ("type".equals(encode)) {
                            setType(encode2);
                        } else if (PushConsts.KEY_SERVICE_PIT.equals(encode)) {
                            this.mExtraParams.put(PushConsts.KEY_SERVICE_PIT, encode2);
