...
public class TBAppLinkSDK {
    ...
    private void initUserTrack() {
        d dVar;
        if (this.sOpenParam != null) {
            if (!e.a(this.sOpenParam.mAppkey)) {
                dVar = new d(TBAppLinkUtil.getApplication().getApplicationContext(), this.sOpenParam.mAppkey);
                a.a(dVar);
                b.a().a(null);
            }
        }
        dVar = new d(TBAppLinkUtil.getApplication().getApplicationContext(), "");
        a.a(dVar);
        b.a().a(null);
    }

    public boolean doAuth(Context context, TBAuthParam tBAuthParam) throws TBAppLinkException {
        if (!(context == null || tBAuthParam == null)) {
            if (tBAuthParam.mListener != null) {
