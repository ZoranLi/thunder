    ...
    private static class ChoreographerAndroidSpringLooper extends SpringLooper {
        ...
        private final FrameCallback mFrameCallback = new FrameCallback() {
            public void doFrame(long j) {
                if (ChoreographerAndroidSpringLooper.this.mStarted != null) {
                    if (ChoreographerAndroidSpringLooper.this.mSpringSystem != null) {
        ...
        private final Runnable mLooperRunnable = new Runnable() {
            public void run() {
                if (LegacyAndroidSpringLooper.this.mStarted) {
                    if (LegacyAndroidSpringLooper.this.mSpringSystem != null) {
