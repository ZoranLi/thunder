        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            if (i3 != 1598968902) {
                ...
                switch (i3) {
                    ...
                    case 7:
                        parcel3.enforceInterface("com.xiaomi.metoknlp.geofencing.IGeoFencing");
                        a(parcel.readDouble(), parcel.readDouble(), parcel.readFloat(), parcel.readLong(), parcel.readInt() != 0 ? (PendingIntent) PendingIntent.CREATOR.createFromParcel(parcel3) : null, parcel.readString(), parcel.readString());
                        return true;
                    case 8:
                        parcel3.enforceInterface("com.xiaomi.metoknlp.geofencing.IGeoFencing");
                    ...
                    case 9:
                        parcel3.enforceInterface("com.xiaomi.metoknlp.geofencing.IGeoFencing");
                        if (parcel.readInt() != 0) {
                            pendingIntent = (PendingIntent) PendingIntent.CREATOR.createFromParcel(parcel3);
                        }
                        a(pendingIntent);
                        return true;
                    default:
