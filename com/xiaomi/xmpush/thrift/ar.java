...
public class ar implements Serializable, Cloneable, a<ar, a> {
    ...
    static {
        ...
        enumMap.put(a.e, new b(SocialConstants.TYPE_REQUEST, (byte) 2, new g((byte) 12, aq.class)));
        ...
        enumMap.put(a.h, new b(Constants.KEY_PACKAGE_NAME, (byte) 2, new c((byte) 11)));
    ...
    L_0x0042:
        ...
        if (r1 != r2) goto L_0x0014;
    L_0x0046:
        r0 = new com.xiaomi.xmpush.thrift.aq;
        r0.<init>();
        r4.e = r0;
        r0 = r4.e;
        r0.a(r5);
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean a(com.xiaomi.xmpush.thrift.ar r7) {
        /*
        r6 = this;
        r0 = 0;
    ...
    L_0x00d3:
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.xmpush.thrift.ar.a(com.xiaomi.xmpush.thrift.ar):boolean");
    }
    ...
    public int b(ar arVar) {
        ...
        if (i()) {
            int a = org.apache.thrift.b.a(this.h, arVar.h);
            if (a != 0) {
                return a;
            }
        }
